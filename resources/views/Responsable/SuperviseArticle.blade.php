...
<head>
    ...
    <title>Superviser les articles</title>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#articles">
                            <i class="fas fa-file-alt me-2"></i>Superviser les Articles
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-9 content">
                ...
                <section id="articles">
                    <h2>Superviser les Articles</h2>
                    <div class="card">
                        <div class="card-body">
                            <p>Voir tous les articles publiés dans votre thème.</p>
                            <ul class="list-group">
                                @foreach($articles as $article)
                                    <li class="list-group-item">{{ $article->title }} - Publié le {{ $article->publication_date }}</li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
